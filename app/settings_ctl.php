...
if (isset($_POST)) {    
    ...
    if (isset($_POST['features'])) {
        ...
        if ($_POST['features']['webstreaming']['enable'] == 1) {
            $redis->hGet('webstreaming', 'enable') == 1 || $jobID[] = wrk_control($redis, 'newjob', $data = array('wrkcmd' => 'webstreaming', 'action' => 'start', 'args' => 1));
        } else {
            $redis->hGet('webstreaming', 'enable') == 0 || $jobID[] = wrk_control($redis, 'newjob', $data = array('wrkcmd' => 'webstreaming', 'action' => 'stop', 'args' => 0));
        }
...
$template->webstreaming = $redis->hGetAll('webstreaming');
